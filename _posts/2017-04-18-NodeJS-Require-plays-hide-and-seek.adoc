...
:hp-tags: node.js, require, require.cache, const, decache, cache, clone, javascript, js, json
...
https://github.com/mimiz/node_require_cache/tree/decache_way[Source code, branch decache_way]
